...
| **Tableau Desktop** | Exploratory prototyping. An early workbook of 12 worksheets was used to test candidate measures and chart forms before the web application was built; several measures defined there — shot accuracy, conversion rate, cards per 100 fouls, close-match rate, and the half-time to full-time transition — were carried into the final application |
